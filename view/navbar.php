    ...
    <div class="nav-left">
        ...
        <div class="nav-links">
            ...
            <?php if ($_SESSION['role'] == 'teacher'): ?>
                <a href="../controller/teacher_controller.php?action=dashboard" title="Kelola User">Manage User</a>
            <?php endif; ?>
            ...
            <div class="question-history-dropdown">
                ...
                <?php else: ?>
                    <?php foreach ($user_questions as $question): ?>
                        <a href="../controller/forum_controller.php?action=question_detail&id=<?php echo $question['question_id']; ?>" 
