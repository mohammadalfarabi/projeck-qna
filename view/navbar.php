...
<div class="navbar">
    <div class="nav-left">
        ...
        <div class="profile">
            <h3><?php echo htmlspecialchars($user['name'] ?? 'Unknown User'); ?></h3>
            <p><?php echo htmlspecialchars($user['email'] ?? 'Unknown Email'); ?></p>
            <p><?php echo htmlspecialchars($user['school_name'] ?? 'Unknown School'); ?></p>
        </div>
