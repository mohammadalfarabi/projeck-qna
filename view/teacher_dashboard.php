...
<div class="container">
    ...
    <form method="GET" action="../controller/teacher_controller.php?action=dashboard"
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="action-btn">
                                <a href="../controller/teacher_controller.php?action=edit_user&id=<?= $user['user_id']; ?>">
                                    Edit
                                </a>
                            </button>

                            <button class="action-btn delete">
                                <a href="../controller/teacher_controller.php?action=delete_user&id=<?= $user['user_id']; ?>"
